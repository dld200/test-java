...
import org.example.mobile.graph.AppElement;
...
public class AppGraphTest {
    ...
    public void testAddElementToPage() {
        // 添加页面和元素
        appGraph.addPage("login_page", "登录页面", "stack");
        AppElement element = new AppElement("login_btn", "button", "登录", "login_btn", 100, 200, 80, 40, "home_page");
    ...
    public void testFindPathNoPath() {
        ...
        appGraph.addElementToPage("login_page", new AppElement("login_btn", "button", "登录", "login_btn", 100, 200, 80, 40));
        appGraph.addElementToPage("settings_page", new AppElement("setting_btn", "button", "设置", "setting_btn", 100, 200, 80, 40));
    ...
    public void testHasCycle() {
        ...
        appGraph.addElementToPage("page_a", new AppElement("btn_b", "button", "到B", "btn_b", 10, 10, 80, 30, "page_b"));
        appGraph.addElementToPage("page_b", new AppElement("btn_c", "button", "到C", "btn_c", 10, 10, 80, 30, "page_c"));
        appGraph.addElementToPage("page_c", new AppElement("btn_a", "button", "到A", "btn_a", 10, 10, 80, 30, "page_a"));
    ...
    public void testSyncAdjacencyList() {
        ...
        pageA.addElement(new AppElement("btn_b", "button", "到B", "btn_b", 10, 10, 80, 30, "page_b"));
