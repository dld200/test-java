...
import org.example.mobile.automation.AndroidAutomation;
...
public class UIElementAndroidParser extends UIElementParser {
...
//        robot.launchApp("ca.snappay.snaplii.test");
        ...
        UIElementParser x = new UIElementAndroidParser();
...
//        System.out.println(jsonOutput);
        ...
        String html = UIElementHtmlSerializer.toHtml(cleanTree, 0.4f);
        // 保存到文件
